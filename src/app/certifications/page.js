...
export default function Certifications() {
  const certifications = [
    ...
    {
      title: "Análise de Sistemas e Prototipagem Web",
      description: "Certificado emitido pela FIAP",
    ...
    {
      title: "ANGULAR: TESTES DE UNIDADE E INTEGRAÇÃO",
      description: "Certificado emitido pela Alura",
    ...
    {
      title: "ANGULAR: BOAS PRÁTICAS EM FORMULÁRIOS",
      description: "Certificado emitido pela Alura",
    ...
    <div className="p-4">
      ...
      <div className="flex flex-col gap-4 items-center">
        {certifications.map((certification) => (
          <div className="border-2 border-slate-100 p-1 md:p-5 flex flex-col gap-2 text-slate-100 w-full md:w-2/3 ">
