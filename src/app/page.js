    ...
    <>
      <div className="text-slate-800">
        ...
        <div className="mt-8 flex items-center justify-center">
          <h1 className="w-fit text-center text-5xl border-4 border-slate-800 p-5 pb-3 font-bold font-mono">
            LUCAS SANTOS
          </h1>
        </div>
        ...
        <div className="border-2 border-slate-800 p-5 font-mono flex flex-col gap-2">
          <Title>Sobre mim</Title>
          <p>
            Sou um desenvolvedor front-end com especialização em tecnologias
            como Angular e TypeScript, acumulando mais de 4 anos de experiência
            desde o meu início como estagiário em novembro de 2019.
          </p>
          <p>
      ...
      <div className="border-2 border-slate-800 p-5 font-mono flex flex-col gap-2 mt-4">
        <Title>Experiência</Title>

        <div>
          <div className="mb-4">
            <h2 className="w-fit text-slate-800">
